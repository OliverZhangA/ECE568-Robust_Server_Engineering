...
public class dbProcess {
    ...
    */
    ...
    public String getProduct_name(long package_id, long product_id) throws SQLException, ClassNotFoundException{
        ...
        String sql_line = "SELECT shopping_commodity.commodity_name FROM shopping_commodity, shopping_order WHERE shopping_order.commodity_id=shopping_commodity.id AND shopping_order.package_info_id=" + package_id + " AND shopping_commodity.id=" + product_id + ";";
        ResultSet R = W.executeQuery(sql_line);

        if(R.next()){
            product_name = R.getString("commodity_name");
            //product_name = name;
            System.out.println("##############select product name result : " + product_name);
        }
        W.close();
        db.close();
        System.out.println("##############product name return is : " + product_name);
        return product_name;
    }
